      ...
      stimuliGenerator
        ...
        $( P.listToVecTH
             [ -- Kickoff
               ...
               (Nothing, Just (AluToken 0 0 0 :> AluToken 0 0 0 :> Nil)), -- 5
               (Nothing, Just (AluToken 1 0 0 :> AluToken 0 0 0 :> Nil)), -- 6
               (Nothing, Just (AluToken 2 0 0 :> AluToken 0 0 0 :> Nil)), -- 7
               (Nothing, Just (AluToken 3 0 20 :> AluToken 0 0 22 :> Nil)), -- 8
               (Nothing, Nothing), -- 9
               (Nothing, Nothing), -- 10
               -- DelayOne
               ...
               (Nothing, Just (AluToken 4 0 11 :> AluToken 0 0 0 :> Nil)), -- 12
               (Nothing, Nothing), -- 13
               (Nothing, Nothing), -- 14
               (Nothing, Nothing) -- 15
             ]
      ...
      outputVerifier'
        ...
        $( P.listToVecTH
             [ (True, Nothing) :: (Bool, Maybe AluOutput), -- 1
               ...
               (True, Nothing), -- 4
               (True, Nothing), -- 5
               (True, Just $ AluOutput (AluToken 30 0 0) $(P.listToVecTH [True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False])), -- 6
               (True, Just $ AluOutput (AluToken 30 0 20) $(P.listToVecTH [True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False])), -- 7
               (True, Just $ AluOutput (AluToken 30 0 22) $(P.listToVecTH [True, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False])), -- 8
               (True, Just $ AluOutput (AluToken 30 0 42) $(P.listToVecTH [False, True, False, False, False, False, False, False, False, False, False, False, False, False, False, False])), -- 9
               (True, Nothing), -- 10
               (True, Nothing), -- 11
               (False, Nothing), -- 12
               (True, Nothing), -- 13
               (True, Just $ AluOutput (AluToken 30 0 11) $(P.listToVecTH [False, True, False, False, False, False, False, False, False, False, False, False, False, False, False, False])), -- 14
               (True, Nothing) -- 15
             ]
         )
